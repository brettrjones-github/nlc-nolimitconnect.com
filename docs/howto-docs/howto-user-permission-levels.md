...
![Person Menu](../assets/howto/person-menu.png)

2. Select Change Friendship Menu Item
![Change Friendship](../assets/howto/popup-menu.png)

3. Select the desired permission level

## Administrator Permission
![Administrator](../assets/howto/permission-admin.png)
...
![Guest](../assets/howto/permission-guest.png)
