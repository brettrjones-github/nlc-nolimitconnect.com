...
![Person Menu](../assets/howto/person-menu-nucG9.png)

## Select View Shared Files

![View Files](../assets/howto/menu-view-files.png)

## Click Play Stream icon

![Stream](../assets/howto/click-play-stream.png)

Movie will play in NLC

## Shared File entry buttons

![Share File Entry Buttons](../assets/howto/shared-files-entry-buttons.png)
